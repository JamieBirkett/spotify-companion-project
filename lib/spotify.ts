import { IArtistsAPIResponse, ITracksAPIResponse } from "@lib/interface";
import { SpotifyAccessToken } from "@/lib/types";
...
return response.json();
  ...
  /* Request to Spotify API to get users current playing song */
